                  ...
                  {testimonials.length > 0 &&
                    testimonials.map((testimoni) => (
                      <tr key={testimoni.id} className="pb-6">
                        ...
                        <td className="text-left space-x-2 align-top flex flex-row">
                          ...
                          <button className="border border-red-500 rounded-full px-2 text-red-500 hover:bg-red-500 hover:text-white flex flex-row items-center space-x-1" onClick={() => handleDeleteClick(testimoni.id)}>
                            <div>Delete</div>
